...
class Conversation extends StatelessWidget {
    ...
    return ListView.builder(
      ...
      itemBuilder: (context, index) {
        ...
        return switch (message.role) {
          .user => _buildUserMessage(context, message),
          .model => _buildModelMessage(context, message),
          .system => _buildSystemMessage(message),
        };
      },
    );
  }
  ...
  Widget _buildModelMessage(BuildContext context, ChatMessage message) {
