...
class StackFrame {
  ...
  static StackFrame? fromStackTraceLine(String line) {
    ...
    assert(
      ...
      'Got a stack frame from package:stack_trace, where a vm or '
      'web frame was expected. '
      'This can happen if FlutterError.demangleStackTrace was not '
      'set in an environment '
      'that propagates non-standard stack traces to the framework, '
      'such as during tests.',
    );
