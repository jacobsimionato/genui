...
void main() {
  ...
  test('Merging change notifiers', () {
    ...
    final merged = GenUiListenable.merge(<GenUiListenable>[source1, source2]);
    void listener1() {
      log.add('listener1');
    }
  ...
  test('Merging change notifiers ignores null', () {
    ...
    final merged = GenUiListenable.merge(<GenUiListenable?>[
      null,
      source1,
      null,
      source2,
  ...
  test('Listenable.merge toString', () {
    ...
    var listenableUnderTest = GenUiListenable.merge(<GenUiListenable>[]);
    expect(listenableUnderTest.toString(), 'Listenable.merge([])');

    listenableUnderTest = GenUiListenable.merge(<GenUiListenable?>[null]);
    expect(listenableUnderTest.toString(), 'Listenable.merge([null])');

    listenableUnderTest = GenUiListenable.merge(<GenUiListenable>[source1]);
    expect(
  ...
  test('Listenable.merge does not leak', () {
    ...
    final listenableUnderTest = GenUiListenable.merge(<GenUiListenable>[
      source1,
      source2,
    ]);
  ...
  test('Remove Listeners while notifying on a list which will not resize', () {
    ...
    final List<String> expectedLog = remainingListenerIndexes
        .map((int i) => 'listener$i')
        .toList();
